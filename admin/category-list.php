                                                        ...
                                                        <div class="modal-body custom-modal-body">
                                                            <form action="./insert-data/edit-category.php" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" name="type" value="<?php echo htmlspecialchars($category['type']); ?>" required>
                                                                </div>
        ...
        <div class="modal-content">
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="./insert-data/add-category.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
